...
exports.getSupervisorSummary = async (req, res) => {
    try {
        ...
        const activeWorkersQuery = `SELECT COUNT(p.id_pekerja) as total_pekerja FROM pekerja p JOIN pengguna u ON p.id_pengguna = u.id_pengguna WHERE u.status_pengguna = 'Aktif'`;
        ...
        const physicallyPresentQuery = `
            ...
            WHERE status_kehadiran IN ('Hadir', 'Telat', 'Lembur', 'Pulang Cepat', 'Izin')
        ...
        summary.absen = total_pekerja - totalHadirFisik;
            ...
            trendData = {
                ...
                datasets: [{
                    ...
                    backgroundColor: [
                        ...
                        statusColors.Lembur, statusColors['Pulang Cepat'], statusColors.Absen
                    ],
                    borderColor: '#ffffff',
                    borderWidth: 2,
                }]
